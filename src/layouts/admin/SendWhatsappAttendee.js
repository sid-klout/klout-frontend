...
function SendWhatsappAttendee(props) {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(fieldErrors).length === 0) {
      ...
      axios
        .post(`/api/notifications-invitation`, formData, {
                      ...
                      <div className="form-group">
                        <div class="col-6">
                          ...
                          >
                            ...
                            We are reaching out to personally invite you to the "<b>Event-Title</b>" on "<b>Event-Date-Time</b>". This exclusive event will gather elite leaders to discuss the latest trends, challenges, and innovations shaping the business landscape.
                            Your presence would be invaluable, and it would be a great opportunity to exchange insights with other industry leaders.
...
export default SendWhatsappAttendee;
